...
public static class ConfigBoundSectionRegistrations
{
        ...
        bool validateOnStart = false)
    {
        ...
        if (global::Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists(configuration.GetSection(global::MyApp.ContactConfig.SectionName)))
        {
            global::MyApp.ContactConfigServiceCollectionExtensions.AddContactConfig(services, configuration);
            if (validateOnStart)
            {
                global::Microsoft.Extensions.DependencyInjection.OptionsBuilderExtensions.ValidateOnStart<global::MyApp.ContactConfig>(
                    global::Microsoft.Extensions.DependencyInjection.OptionsServiceCollectionExtensions.AddOptions<global::MyApp.ContactConfig>(services));
            }
        }
