...
public static class ConfigBoundSectionRegistrations
{
        ...
        bool validateOnStart = false)
    {
        ...
        if (global::Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists(configuration.GetSection(global::MyApp.PlainConfig.SectionName)))
        {
            global::MyApp.PlainConfigServiceCollectionExtensions.AddPlainConfig(services, configuration);
            if (validateOnStart)
            {
                global::Microsoft.Extensions.DependencyInjection.OptionsBuilderExtensions.ValidateOnStart<global::MyApp.PlainConfig>(
                    global::Microsoft.Extensions.DependencyInjection.OptionsServiceCollectionExtensions.AddOptions<global::MyApp.PlainConfig>(services));
            }
        }
