...
public static class ConfigBoundSectionRegistrations
{
        ...
        bool validateOnStart = false)
    {
        ...
        if (global::Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists(configuration.GetSection(global::MyApp.PasswordConfig.SectionName)))
        {
            global::MyApp.PasswordConfigServiceCollectionExtensions.AddPasswordConfig(services, configuration);
            if (validateOnStart)
            {
                global::Microsoft.Extensions.DependencyInjection.OptionsBuilderExtensions.ValidateOnStart<global::MyApp.PasswordConfig>(
                    global::Microsoft.Extensions.DependencyInjection.OptionsServiceCollectionExtensions.AddOptions<global::MyApp.PasswordConfig>(services));
            }
        }
