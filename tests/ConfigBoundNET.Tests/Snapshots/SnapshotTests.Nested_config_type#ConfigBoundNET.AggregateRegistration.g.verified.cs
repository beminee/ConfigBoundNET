...
public static class ConfigBoundSectionRegistrations
{
        ...
        bool validateOnStart = false)
    {
        ...
        if (global::Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists(configuration.GetSection(global::MyApp.RetryPolicy.SectionName)))
        {
            ...
            if (validateOnStart)
            {
                global::Microsoft.Extensions.DependencyInjection.OptionsBuilderExtensions.ValidateOnStart<global::MyApp.RetryPolicy>(
                    global::Microsoft.Extensions.DependencyInjection.OptionsServiceCollectionExtensions.AddOptions<global::MyApp.RetryPolicy>(services));
            }
        }
