...
public static class ConfigBoundSectionRegistrations
{
        ...
        bool validateOnStart = false)
    {
        ...
        if (global::Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists(configuration.GetSection(global::MyApp.AuthConfig.SectionName)))
        {
            global::MyApp.AuthConfigServiceCollectionExtensions.AddAuthConfig(services, configuration);
            if (validateOnStart)
            {
                global::Microsoft.Extensions.DependencyInjection.OptionsBuilderExtensions.ValidateOnStart<global::MyApp.AuthConfig>(
                    global::Microsoft.Extensions.DependencyInjection.OptionsServiceCollectionExtensions.AddOptions<global::MyApp.AuthConfig>(services));
            }
        }
